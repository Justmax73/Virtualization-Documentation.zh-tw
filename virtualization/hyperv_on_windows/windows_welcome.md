    ...
    <tr valign="top">
        ...
        <td valign="top">
            ...
            <ul>
                ...
                <li class="unordered">[透過 Hyper-V 使用檢查點](quick_start\walkthrough_checkpoints.md)<br /><br /></li>
                <li class="unordered">[虛擬機器匯出和匯入](quick_start\walkthrough_export_import.md)<br /><br /></li>
