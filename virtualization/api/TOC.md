# [概觀](./index.md)
# [Windows Hypervisor 平台 API](./hypervisor-platform/hypervisor-platform.md)
...
### [資料類型](./hypervisor-platform/funcs/WHvPartitionPropertyDataTypes.md)
## [WHvGetVirtualProcessorRegisters](./hypervisor-platform/funcs/WHvGetVirtualProcessorRegisters.md)
### [資料類型](./hypervisor-platform/funcs/WHvVirtualProcessorDataTypes.md)
...
### [結束內容](./hypervisor-platform/funcs/WHvExitContextDataTypes.md)
### [記憶體存取](./hypervisor-platform/funcs/MemoryAccess.md)
### [I/O 連接埠存取](./hypervisor-platform/funcs/IOPortAccess.md)
### [MSR 存取](./hypervisor-platform/funcs/MSRAccess.md)
### [CPUID 存取](./hypervisor-platform/funcs/CPUIDAccess.md)
### [虛擬處理器例外狀況](./hypervisor-platform/funcs/VirtualProcessorException.md)
### [中斷視窗](./hypervisor-platform/funcs/InterruptWindow.md)
### [不支援的功能](./hypervisor-platform/funcs/UnsupportableFeature.md)
### [執行已取消](./hypervisor-platform/funcs/ExecutionCancelled.md)
...
# [Hypervisor 指令模擬器](./hypervisor-instruction-emulator/hypervisor-instruction-emulator.md)
## 指令模擬
### [I/O 連接埠存取](./hypervisor-instruction-emulator/funcs/IOPortAccessIE.md)
### [MMIO 存取](./hypervisor-instruction-emulator/funcs/MMIOAccessIE.md)
## 模擬器結構
...
# [VM 儲存狀態傾印提供者 API](./vm-dump-provider/vm-dump-provider.md)
