...
**移除多個 NAT**  
我們看到報告顯示意外建立了多個 NAT 網路。 這是近期組建的問題所造成 (包括 Windows Server 2016 Technical Preview 5 和 Windows 10 Insider Preview 組建)。 如果您在執行 docker 網路 ls 或 Get-ContainerNetwork 之後，看到多個 NAT 網路，請從提高權限的 PowerShell 執行下列作業︰
